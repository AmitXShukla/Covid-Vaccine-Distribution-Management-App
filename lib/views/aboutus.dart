        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const ListTile(
              ...
              title: Text('Dictionary based auto-completion/auto-sync (Pro)'),
              subtitle: Text(
            ...
            const ListTile(
              ...
              title: Text('GBs of pictures, documents, Lab reports, Receipts'),
              subtitle: Text(
            ...
            const ListTile(
              ...
              title:
                  Text('Social authentication, SMS, EMAIL, WhatsAPP API (Pro)'),
              subtitle: Text(
