...
// import 'package:vaccine_dist/shared/custom_forms.dart';
      ...
      child: Center(
        child: Column(
          children: <Widget>[
            ...
            Text(
                "This is a DEMO app only and doesn't gurantee any vaccine distribution. you can use any email and password to login as patient. to login as Admin, use info@elishconsulting.com password1",
                style: cHeaderText),
            SizedBox(
              width: 10,
              height: 10,
